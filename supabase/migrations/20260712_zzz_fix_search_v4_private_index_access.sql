...
-- Preserve the v3 compatibility endpoint for older clients. It reaches the
-- private index indirectly through the canonical public view, so it needs the
-- same narrow privileged execution boundary.
