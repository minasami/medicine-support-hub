-- 20260720240000_fix_auto_publish_rls_final.sql
-- Fix the RLS policy to accommodate auto-published rows and revert the trigger to BEFORE INSERT
-- This ensures the data is inserted perfectly the first time and satisfies RLS.
