-- 20260720200000_auto_publish_verified_submissions.sql
-- Create trigger to automatically approve and publish verified company representative submissions.
...
begin
  ...
  if new.submitter_kind = 'company_representative' and new.status = 'submitted' then
    ...
    if found and profile_row.verification_status = 'verified' then
      ...
      -- Refresh materialized views synchronously (this matches the admin publish flow)
