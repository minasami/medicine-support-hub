...
const routes = {
  ...
  search: { path: "/search", title: "Universal Healthcare Search | Medicine Support Hub", description: "Search medicines, verified products, companies, generics, disease areas, sources, pharmacy operations, programs, and healthcare workflows." },
  notifications: { path: "/notifications", title: "Platform Notifications | Medicine Support Hub", description: "Review Medicine Support Hub announcements and manage medicine, company, marketplace, learning, and favorite update preferences." },
  learn: { path: "/learn", title: "Healthcare Learning Center | Medicine Support Hub", description: "Role-based bilingual onboarding for patients, physicians, pharmacies, laboratories, radiology centers, payers, institutions, and platform administrators.", keywords: "healthcare training, physician workflow training, pharmacy training, patient portal training, laboratory workflow, insurance authorization training" },
  journey: { path: "/journey", title: "Connected Healthcare Journey | Medicine Support Hub", description: "Navigate the patient, physician, diagnostics, insurance, pharmacy, medicine-support, training, and governance journey with transparent release status and direct access paths.", keywords: "connected healthcare journey, patient journey platform, physician workflow, laboratory workflow, radiology workflow, insurance authorization, pharmacy dispensing, healthcare training" },
  ...
  marketplace: { path: "/marketplace", title: "Verified B2B Medicine Marketplace | Medicine Support Hub", description: "Compare approved medicine offers from verified pharmacies, warehouses, and distribution companies, then request accountable B2B quotations linked to canonical medicine evidence.", keywords: "medicine marketplace, pharmacy suppliers, medicine warehouses, medicine distributors, B2B medicine quotes" },
  verifiedProducts: { path: "/verified-products", title: "Verified Medicine Products Database | Medicine Support Hub", description: "Search verified medicine products by name, generic, company, disease area, prescription status, specification, and highest verified price.", keywords: "verified medicine products, medicine prices, generic medicines, pharmaceutical companies" },
  ...
  therapeuticCategories: { path: "/therapeutic-categories", title: "Therapeutic Categories and Medicine Classes | Medicine Support Hub", description: "Explore catalog-backed therapeutic-category profiles connected to canonical medicine products, public knowledge, sharing, and reviewed contribution workflows.", keywords: "therapeutic categories, drug classes, medicine class directory" },
  ...
  disclosures: { path: "/disclosures", title: "Advertising and Affiliate Disclosure | Medicine Support Hub", description: "Review Medicine Support Hub advertising, Google AdSense, Amazon affiliate, commercial-content separation, and safety disclosures.", type: "article" },
};
...
export default async function handler(request, response) {
  ...
  try {
    const html = injectMeta(await fetchIndex(request), definition, publicRobots);
