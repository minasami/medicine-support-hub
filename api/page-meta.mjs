...
const routes = {
  ...
  network: {
    ...
    description: "Explore a live graph linking medicines, verified products, official company profiles, reviewed contributions, disease areas, pharmacies, healthcare programs, procurement, and impact reporting.",
  },
  companies: {
    path: "/companies",
  ...
  manifesto: {
    ...
    description: "Read the principles behind a connected, evidence-led platform for medicines, patient support, pharmacies, NGOs, companies, and healthcare programs.",
    type: "article",
  },
  vision: {
    path: "/vision",
    title: "Vision | Medicine Support Hub",
    description: "See the vision for an interconnected healthcare platform joining medicines, patients, companies, pharmacies, NGOs, programs, evidence, and impact.",
  },
  platform: {
    path: "/platform",
    title: "Connected Healthcare Platform | Medicine Support Hub",
    description: "Explore the platform connecting medicine intelligence, company participation, patient support, pharmacy operations, NGO programs, procurement, and reporting.",
  },
  solutions: {
    path: "/solutions",
    title: "Healthcare Solutions | Medicine Support Hub",
    description: "Discover connected solutions for medicine search, company participation, patient assistance, pharmacy operations, NGO delivery, procurement, and impact reporting.",
  },
  security: {
    path: "/security",
    title: "Security and Data Protection | Medicine Support Hub",
    description: "Review the security, privacy, authorization, source attribution, moderation, and data-protection principles used by Medicine Support Hub.",
  },
  research: {
    path: "/research",
  ...
  contact: {
    ...
    description: "Contact Medicine Support Hub about healthcare partnerships, medicine data, company participation, NGO programs, pharmacy operations, and platform collaboration.",
  },
  brand: {
    path: "/brand",
  ...
  impact: {
    ...
    description: "Connect medicine support, company partnerships, beneficiary outcomes, program delivery, and evidence into clear healthcare impact reporting.",
  },
};
...
function hasUserQuery(request) {
  return Object.keys(request.query || {}).some((key) => key !== "route");
}
...
function injectMeta(html, definition, robots) {
  ...
  const structured = {
    ...
    "@graph": [
      {
        "@type": definition.type === "article" ? "Article" : "WebPage",
        "@id": `${canonicalUrl}#page`,
        name: definition.title.replace(/ \| Medicine Support Hub$/, ""),
        url: canonicalUrl,
      ...
      },
      {
        ...
        itemListElement: [
          ...
          ...(definition.path === "/" ? [] : [{ "@type": "ListItem", position: 2, name: definition.title.replace(/ \| Medicine Support Hub$/, ""), item: canonicalUrl }]),
        ],
      },
    ],
  };
...
export default async function handler(request, response) {
  ...
  if (!definition) {
    ...
    response.end("Unknown public route.");
    return;
  }
