...
const HealthcareDirectory = lazy(() => import("@/pages/healthcare-directory"));
const CareWorkspace = lazy(() => import("@/pages/care-workspace"));
const PatientCareProfile = lazy(() => import("@/pages/patient-care-profile"));
  ...
  return (
    <Suspense fallback={<RouteLoading />}>
      <Switch>
        ...
        <Route
          path="/marketplace/sellers/:slug"
          component={MedicineMarketplace}
        />
        ...
        <Route
          path="/therapeutic-categories/:slug"
          component={TherapeuticCategories}
        />
        <Route
          path="/therapeutic-categories"
          component={TherapeuticCategories}
        />
        <Route path="/clinics/emr" component={CareWorkspace} />
        <Route path="/clinics" component={HealthcareDirectory} />
        <Route path="/pharmacies/pms" component={CareWorkspace} />
        <Route path="/pharmacies" component={HealthcareDirectory} />
        <Route path="/labs/lms" component={CareWorkspace} />
        <Route path="/labs" component={HealthcareDirectory} />
        <Route path="/radiology/rms" component={CareWorkspace} />
        <Route path="/radiology" component={HealthcareDirectory} />
        <Route path="/profiles/:patientId" component={PatientCareProfile} />
        <Route
