        ...
        try {
          ...
          if (dataset && Array.isArray(dataset.medicines)) {
            ...
            safeRows = sliced.map((m: any) => ({
              ...
              price_currency: "EGP",
              min_price_egp: m.current_price_egp !== undefined && m.current_price_egp !== null ? Number(m.current_price_egp) : null,
              max_price_egp: m.current_price_egp !== undefined && m.current_price_egp !== null ? Number(m.current_price_egp) : null,
              price_observation_count: 1,
              distinct_price_count: 1,
              has_price_history: true,
              source_record_count: 1,
              source_count: 1,
              source_systems: ["official_dataset"],
              ...
              current_price_source: "official_dataset",
              complete_field_count: 12,
              available_field_count: 12,
              completeness_score: 100,
              completeness_percent: 100,
              relevance: 100,
              match_reason: "static_dataset_match",
              matched_terms: 1,
