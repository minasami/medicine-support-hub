...
export default function PatientRequestPage() {
  ...
  return <div className="container mx-auto max-w-4xl px-4 py-8">
    ...
    <form onSubmit={submit} className="space-y-6">
      ...
      <div className="space-y-2"><Label>Upload Prescription / Medical Document (Appwrite Storage)</Label><Input type="file" accept="image/*,.pdf" onChange={async (e) => {
        ...
        try {
          ...
          if (res?.url) {
            toast({ title: "Prescription Attached", description: `Uploaded ${res.filename} to Appwrite Bucket.` });
          }
        } catch {}
