...
export default function MedicineDetail() {
  ...
  return <main className="container mx-auto max-w-7xl px-4 py-8">
    ...
    <div className="mt-4"><ShareContributeActions title={title} contributionUrl={`/industry?medicine=${product.canonical_id}#participate`} /></div><PublicKnowledgePanel type="medicine" name={product.scientific_name || title} />
