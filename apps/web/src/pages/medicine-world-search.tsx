      ...
      <div className="mx-auto max-w-3xl space-y-6 px-4 py-8">
        <div>
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            {ar
              ? "اجمع نتائج OpenFDA وRxNorm مع روابط إلى DailyMed وEMA وPubChem. البيانات المصرية تبقى في الموسوعة المحلية."
              : "Aggregate OpenFDA + RxNorm and jump to DailyMed, EMA, PubChem, and more. Egypt-specific prices stay in the local encyclopedia."}
          </p>
        </div>
