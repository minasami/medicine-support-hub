...
const seoByPath: Record<string, SeoDefinition> = {
  ...
  "/therapeutic-categories": { title: "Therapeutic Categories and Medicine Classes | Medicine Support Hub", description: "Explore medicine classes and therapeutic-category profiles connected to canonical medicines and attributed public knowledge.", keywords: "therapeutic categories, medicine classes, drug class directory" },
  ...
  "/notifications": { title: "Platform Notifications | Medicine Support Hub", description: "Review Medicine Support Hub announcements and manage medicine, company, marketplace, learning, and favorite update preferences." },
  "/disclosures": { title: "Advertising and Affiliate Disclosure | Medicine Support Hub", description: "Review Medicine Support Hub advertising, Google AdSense, Amazon affiliate, commercial-content separation, and safety disclosures.", type: "article" },
